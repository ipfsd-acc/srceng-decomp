...
// Original: utils/dumpworld/dumpworld.cpp
// Functions: 46
// ============================================================

#include "utils\dumpworld\dumpworld.h"
...
//------------------------------------------------------------------------------
// Address: 0x00401020
// Name: public: virtual bool CDumpWorldApp::Create(void)
// Source: json
//------------------------------------------------------------------------------
bool __thiscall CDumpWorldApp::Create(CDumpWorldApp *this)
{
...
//------------------------------------------------------------------------------
// Address: 0x00401050
// Name: private: bool CDumpWorldApp::SetupSearchPaths(void)
// Source: json
//------------------------------------------------------------------------------
bool __thiscall CDumpWorldApp::SetupSearchPaths(CDumpWorldApp *this)
{
  bool result; // al
...
//------------------------------------------------------------------------------
// Address: 0x004010B0
// Name: public: virtual bool CDumpWorldApp::PreInit(void)
// Source: json
//------------------------------------------------------------------------------
char __thiscall CDumpWorldApp::PreInit(CDumpWorldApp *this)
{
  ...
  if ( g_pFullFileSystem == nullptr || g_pWorldRendererMgr == nullptr )
    return 0;
  if ( !CDumpWorldApp::SetupSearchPaths(this) )
...
//------------------------------------------------------------------------------
// Address: 0x00401120
// Name: public: virtual void CDumpWorldApp::PostShutdown(void)
// Source: json
//------------------------------------------------------------------------------
void __thiscall CDumpWorldApp::PostShutdown(CDumpWorldApp *this)
{
...
//------------------------------------------------------------------------------
// Address: 0x00401130
// Name: void DumpSummary(class IWorldRenderer __near *)
// Source: json
//------------------------------------------------------------------------------
void __cdecl DumpSummary(IWorldRenderer *pWorldRenderer)
{
  const WorldFileHeader_t *v2; // edi
  int v3; // eax
  int v4; // eax
  IBVHNode *v5; // edi
  char v6; // al
  IResourceDictionary *v7; // ebx
  int v8; // ebx
  int v9; // edi
  int v10; // ebx
  char *v11; // eax
  ...
  int v23; // eax
  int v24; // eax
  float flNumIBBytes; // [esp+30h] [ebp-A4h]
  int nVertexBuffers; // [esp+34h] [ebp-A0h]
  int nPropIBBytes; // [esp+38h] [ebp-9Ch]
  int nPropTexBytes; // [esp+3Ch] [ebp-98h]
  int nPropTex; // [esp+40h] [ebp-94h]
  int nScalingTexBytes; // [esp+44h] [ebp-90h]
  int nTransientResources; // [esp+48h] [ebp-8Ch]
  int nInstVBs; // [esp+4Ch] [ebp-88h]
  int nTransientMemBytes; // [esp+50h] [ebp-84h]
  int nPropVBs; // [esp+54h] [ebp-80h]
  int nNonPageableResources; // [esp+58h] [ebp-7Ch]
  int nBakedTexBytes; // [esp+5Ch] [ebp-78h]
  int nNonPageableBytes; // [esp+60h] [ebp-74h]
  int nAtlasTexBytes; // [esp+64h] [ebp-70h]
  int nSysMemResources; // [esp+68h] [ebp-6Ch]
  int nIndexBuffers; // [esp+6Ch] [ebp-68h]
  int nSysMemBytes; // [esp+70h] [ebp-64h]
  int nInstVBBytes; // [esp+74h] [ebp-60h]
  int nKDTreeBytes; // [esp+78h] [ebp-5Ch]
  int nUniqueVBBytes; // [esp+7Ch] [ebp-58h]
  int nMaterials; // [esp+80h] [ebp-54h]
  int nPropVBBytes; // [esp+84h] [ebp-50h]
  int nMaterialBytes; // [esp+88h] [ebp-4Ch]
  int nBakedTex; // [esp+8Ch] [ebp-48h]
  int nConstantBuffers; // [esp+90h] [ebp-44h]
  int nScalingTex; // [esp+94h] [ebp-40h]
  int nUniqueIBs; // [esp+98h] [ebp-3Ch]
  int nAtlasTex; // [esp+9Ch] [ebp-38h]
  int nUniqueIBBytes; // [esp+A0h] [ebp-34h]
  int nPropIBs; // [esp+A4h] [ebp-30h]
  int nUniqueVBs; // [esp+A8h] [ebp-2Ch]
  IResourceDictionary *pDictionary; // [esp+ACh] [ebp-28h]
  int nTextures; // [esp+B0h] [ebp-24h]
  float nTexturesa; // [esp+B0h] [ebp-24h]
  int nKDTrees; // [esp+B4h] [ebp-20h]
  int nKDTreesa; // [esp+B4h] [ebp-20h]
  int nUniqueUVNodes; // [esp+B8h] [ebp-1Ch]
  int nUniqueUVNodesa; // [esp+B8h] [ebp-1Ch]
  int nResources; // [esp+BCh] [ebp-18h]
  int nResourcesa; // [esp+BCh] [ebp-18h]
  int nVertColorNodes; // [esp+C0h] [ebp-14h]
  int nVertColorNodesa; // [esp+C0h] [ebp-14h]
  int nIBBytes; // [esp+C4h] [ebp-10h]
  int nIBBytesa; // [esp+C4h] [ebp-10h]
  int nFullResNodes; // [esp+C8h] [ebp-Ch]
  int nFullResNodesa; // [esp+C8h] [ebp-Ch]
  int r; // [esp+CCh] [ebp-8h]
  int ra; // [esp+CCh] [ebp-8h]
  float rb; // [esp+CCh] [ebp-8h]
  int i; // [esp+D0h] [ebp-4h]
  int ia; // [esp+D0h] [ebp-4h]
  int ib; // [esp+D0h] [ebp-4h]
  BVHChunkType_t entry; // [esp+DCh] [ebp+8h]
  CBVHDictionaryEntry *entrya; // [esp+DCh] [ebp+8h]
  CBVHDictionaryEntry *entryd; // [esp+DCh] [ebp+8h]
  CBVHDictionaryEntry *entryb; // [esp+DCh] [ebp+8h]
  CBVHDictionaryEntry *entryc; // [esp+DCh] [ebp+8h]
  float entrye; // [esp+DCh] [ebp+8h]

  v2 = pWorldRenderer->GetHeader(this: pWorldRenderer);
  pDictionary = pWorldRenderer->GetResourceDictionary(this: pWorldRenderer);
  _Msg(a1: "World Information\n");
  _Msg(a1: "---------------------------------------------------------\n");
  _Msg(a1: "World version:                              %d\n", v2->m_nFileVersion);
  _Msg(
    a1: "WorldUnits per-tile:                        <%.2f,%.2f,%.2f>\n",
    v2->m_vWorldUnitsPerTile.x,
    v2->m_vWorldUnitsPerTile.y,
    v2->m_vWorldUnitsPerTile.z);
  v3 = pWorldRenderer->GetNumNodes(this: pWorldRenderer);
  _Msg(a1: "NodeCount:                                  %d\n", v3);
  for ( entry = CHUNK_TYPE_RESOURCE_DICTIONARY; entry < MAX_CHUNK_TYPES; ++entry )
  {
    v4 = pWorldRenderer->GetChunkSize(this: pWorldRenderer, a2: entry);
    _Msg(a1: "%s chunk:\t\t\t\t\t\t\t%d bytes\n", g_pChunkTypeToName[entry], v4);
  }
  _Msg(a1: "\n");
  _Msg(a1: "Build params\n");
  _Msg(a1: "---------------------------------------------------------\n");
  _Msg(a1: "Min dist to camera:                         %.2f\n", v2->m_BuilderParams.m_flMinDistToCamera);
  _Msg(a1: "Min atlas distance:                         %.2f\n", v2->m_BuilderParams.m_flMinAtlasDist);
  _Msg(a1: "Min simplified distance:                    %.2f\n", v2->m_BuilderParams.m_flMinSimplifiedDist);
  _Msg(
    a1: "Target FOV (X):                             %.2f deg\n",
    (float)(v2->m_BuilderParams.m_flHorzFOV * 57.29578));
  _Msg(a1: "Target screen width:                        %.2f\n", (float)(v2->m_BuilderParams.m_flHalfScreenWidth * 2.0));
  _Msg(
    a1: "Atlas texture size:                         <%d,%d>\n",
    v2->m_BuilderParams.m_nAtlasTextureSizeX,
    v2->m_BuilderParams.m_nAtlasTextureSizeY);
  _Msg(
    a1: "Unique param textures size:                 <%d,%d>\n",
    v2->m_BuilderParams.m_nUniqueTextureSizeX,
    v2->m_BuilderParams.m_nUniqueTextureSizeY);
  _Msg(a1: "Estimated compressed atlas size:            %d bytes\n", v2->m_BuilderParams.m_nCompressedAtlasSize);
  _Msg(a1: "Atlas gutter size:                          %.2f texels\n", v2->m_BuilderParams.m_flGutterSize);
  _Msg(a1: "Unique UV chart threshold (cos(edgeangle)): %.2f\n", v2->m_BuilderParams.m_flUVMapThreshold);
  _Msg(a1: "Maximum atlas indirection registers:        %d\n", v2->m_BuilderParams.m_nMaxTexScaleSlots);
  _Msg(a1: "Wrap in atlas:                              %d\n", v2->m_BuilderParams.m_bWrapInAtlas);
  _Msg(a1: "\n");
  _Msg(a1: "Node summary\n");
  _Msg(a1: "---------------------------------------------------------\n");
  nIBBytes = 0;
  nVertColorNodes = 0;
  nUniqueUVNodes = 0;
  ...
  nKDTrees = 0;
  for ( entrya = nullptr;
        (int)entrya < pWorldRenderer->GetNumNodes(this: pWorldRenderer);
        entrya = (CBVHDictionaryEntry *)((char *)entrya + 1) )
  {
    v5 = pWorldRenderer->GetNode(this: pWorldRenderer, a2: entrya);
    v6 = v5->GetFlags(this: v5);
    if ( (v6 & 1) != 0 )
    {
      ++nIBBytes;
      if ( (v5->GetFlags(this: v5) & 2) != 0 )
        ++nUniqueUVNodes;
      else
        ++nVertColorNodes;
    }
    ...
    if ( (v5->GetFlags(this: v5) & 8) != 0 )
      ++nKDTrees;
    i += v5->GetNumDrawCalls(this: v5);
  }
  _Msg(a1: "Simplified nodes (coarse LOD):              %d\n", nIBBytes);
  _Msg(a1: "\tVertex color only nodes:            %d\n", nVertColorNodes);
  _Msg(a1: "\tUnique param nodes:                 %d\n", nUniqueUVNodes);
  _Msg(a1: "Atlased nodes (med LOD):                    %d\n", nResources);
  _Msg(a1: "Full res nodes (fine LOD):                  %d\n", nFullResNodes);
  _Msg(a1: "Total draw calls:                           %d\n", i);
  _Msg(a1: "Total KD-trees:                             %d\n", nKDTrees);
  _Msg(a1: "\n");
  _Msg(a1: "Dictionary summary\n");
  _Msg(a1: "---------------------------------------------------------\n");
  v7 = pDictionary;
  entryd = (CBVHDictionaryEntry *)pDictionary->GetPageFile(this: pDictionary);
  r = v7->GetNumLayoutDescs(this: v7);
  nResourcesa = v7->GetNumResources(this: v7);
  _Msg(a1: "Page file: %s\n\n", (const char *)entryd);
  _Msg(a1: "Input layouts: %d\n", r);
  v8 = 0;
  ia = 0;
  if ( r > 0 )
  {
    while ( 1 )
    {
      v9 = (int)pDictionary->GetLayoutDesc(this: pDictionary, a2: v8);
      _Msg(a1: "  Layout: %d, %s\n", v8, (const char *)v9);
      v10 = 0;
      if ( *(int *)(v9 + 32) > 0 )
      {
        ...
        do
        {
          v11 = (char *)entryb + *(_DWORD *)(v9 + 40);
          _Msg(
            a1: "    S: %d, Name: %s, Index: %d, Fmt: %d, Off: %d, Type: %d, Rate: %d\n",
            *((_DWORD *)v11 + 11),
            v11,
            *((_DWORD *)v11 + 8),
            *((_DWORD *)v11 + 9),
            ...
            *((_DWORD *)v11 + 12),
            *((_DWORD *)v11 + 13));
          entryb = (CBVHDictionaryEntry *)((char *)entryb + 56);
          ++v10;
        }
  ...
  nKDTreesa = 0;
  nSysMemResources = 0;
  nNonPageableResources = 0;
  nTransientResources = 0;
  nSysMemBytes = 0;
  nNonPageableBytes = 0;
  nTransientMemBytes = 0;
  nMaterialBytes = 0;
  nVertColorNodesa = 0;
  nIBBytesa = 0;
  ib = 0;
  ...
  if ( nResourcesa > 0 )
  {
    do
    {
      v14 = (int)pDictionary->GetEntry(this: pDictionary, a2: v13);
      v15 = *(_DWORD *)(v14 + 16);
      entryc = (CBVHDictionaryEntry *)v14;
      switch ( *(_DWORD *)(v14 + 32) )
      {
        case 0:
          ++nVertexBuffers;
          v16 = v15 - 12;
          nVertColorNodesa += v15 - 12;
          strstr(str1: (unsigned __int8 *)(v14 + 36), str2: "unique");
          if ( v17 != 0 )
          {
            ++nUniqueVBs;
            nUniqueVBBytes += v16;
          ...
          {
            strstr(str1: (unsigned __int8 *)entryc->m_pName, str2: "instancedata");
            if ( v18 != 0 )
            {
              ++nInstVBs;
              nInstVBBytes += v16;
        ...
        case 3:
          ++nTextures;
          v21 = v15 - 28;
          nUniqueUVNodesa += v15 - 28;
          strstr(str1: (unsigned __int8 *)(v14 + 36), str2: "atlasscalingtexture");
          if ( v22 != 0 )
          {
            ++nScalingTex;
            nScalingTexBytes += v21;
          }
          else
          {
            strstr(str1: (unsigned __int8 *)entryc->m_pName, str2: "atlas");
            if ( v23 != 0 )
            {
              ++nAtlasTex;
              nAtlasTexBytes += v21;
            ...
            {
              strstr(str1: (unsigned __int8 *)entryc->m_pName, str2: "baked");
              if ( v24 != 0 )
              {
                ++nBakedTex;
                nBakedTexBytes += v21;
      ...
      switch ( entryc->m_Flags )
      {
        case 1u:
          ++nNonPageableResources;
          nNonPageableBytes += v15;
          break;
        case 2u:
          ++nSysMemResources;
          nSysMemBytes += v15;
    ...
    while ( v13 < nResourcesa );
    v12 = nFullResNodesa;
  }
  _Msg(a1: "           \tCount \t\tSize(bytes)\t%% of total\n");
  _Msg(a1: "---------------------------------------------------------\n");
  entrye = 1.0 / (float)((float)v12 * 0.0099999998);
  _Msg(a1: "Total:     \t%d \t\t%d\t%.2f\n", nResourcesa, v12, (float)(entrye * (float)v12));
  _Msg(a1: "\n");
  _Msg(a1: "Textures:  \t%d \t\t%d\t%.2f\n", nTextures, nUniqueUVNodesa, (float)(entrye * (float)nUniqueUVNodesa));
  nTexturesa = 1.0 / (float)((float)nUniqueUVNodesa * 0.0099999998);
  _Msg(a1: "   Prop:   \t%d \t\t%d\t%.2f\n", nPropTex, nPropTexBytes, (float)((float)nPropTexBytes * nTexturesa));
  _Msg(a1: "   Atlas:  \t%d \t\t%d\t%.2f\n", nAtlasTex, nAtlasTexBytes, (float)((float)nAtlasTexBytes * nTexturesa));
  _Msg(
    a1: "   Scale:  \t%d \t\t%d\t%.2f\n",
    nScalingTex,
    nScalingTexBytes,
    (float)((float)nScalingTexBytes * nTexturesa));
  _Msg(a1: "   Baked:  \t%d \t\t%d\t%.2f\n", nBakedTex, nBakedTexBytes, (float)((float)nBakedTexBytes * nTexturesa));
  _Msg(a1: "\n");
  _Msg(
    a1: "VBs:       \t%d \t\t%d\t%.2f\n",
    nVertexBuffers,
    nVertColorNodesa,
    (float)(entrye * (float)nVertColorNodesa));
  rb = 1.0 / (float)((float)nVertColorNodesa * 0.0099999998);
  _Msg(a1: "   Prop    \t%d \t\t%d\t%.2f\n", nPropVBs, nPropVBBytes, (float)((float)nPropVBBytes * rb));
  _Msg(a1: "   Unique  \t%d \t\t%d\t%.2f\n", nUniqueVBs, nUniqueVBBytes, (float)((float)nUniqueVBBytes * rb));
  _Msg(a1: "   InstData\t%d \t\t%d\t%.2f\n", nInstVBs, nInstVBBytes, (float)((float)nInstVBBytes * rb));
  _Msg(a1: "\n");
  _Msg(a1: "IBs:       \t%d \t\t%d\t%.2f\n", nIndexBuffers, nIBBytesa, (float)(entrye * (float)nIBBytesa));
  flNumIBBytes = 1.0 / (float)((float)nIBBytesa * 0.0099999998);
  _Msg(a1: "   Prop    \t%d \t\t%d\t%.2f\n", nPropIBs, nPropIBBytes, (float)((float)nPropIBBytes * flNumIBBytes));
  _Msg(a1: "   Unique  \t%d \t\t%d\t%.2f\n", nUniqueIBs, nUniqueIBBytes, (float)((float)nUniqueIBBytes * flNumIBBytes));
  _Msg(a1: "\n");
  _Msg(a1: "CBs:       \t%d \t\t%d\t%.2f\n", nConstantBuffers, v8, (float)((float)v8 * entrye));
  _Msg(a1: "Materials: \t%d \t\t%d\t%.2f\n", nMaterials, nMaterialBytes, (float)((float)nMaterialBytes * entrye));
  _Msg(a1: "KD-Trees:  \t%d \t\t%d\t%.2f\n", nKDTreesa, nKDTreeBytes, (float)((float)nKDTreeBytes * entrye));
  _Msg(a1: "SysMem res:\t%d \t\t%d\t%.2f\n", nSysMemResources, nSysMemBytes, (float)((float)nSysMemBytes * entrye));
  _Msg(
    a1: "NoPage res:\t%d \t\t%d\t%.2f\n",
    nNonPageableResources,
    nNonPageableBytes,
    (float)((float)nNonPageableBytes * entrye));
  _Msg(
    a1: "Trans  res:\t%d \t\t%d\t%.2f\n",
    nTransientResources,
    nTransientMemBytes,
    (float)((float)nTransientMemBytes * entrye));
  _Msg(a1: "\n");
}

//------------------------------------------------------------------------------
// Address: 0x00401B50
// Name: void DumpDrawCall(class CBVHDrawCall __near &)
// Source: json
//------------------------------------------------------------------------------
void __cdecl DumpDrawCall(CBVHDrawCall *drawCall)
{
  int v2; // ebx
  BVHResourceBinding_t *v3; // eax
  CBVHDrawCall *drawCalla; // [esp+2Ch] [ebp+8h]

  _Msg(a1: "  Input layout index:                %d\n", drawCall->m_nInputLayout);
  _Msg(
    a1: "  Bounds:                            <%0.2f,%0.2f,%0.2f>\n",
    drawCall->m_Bounds.m_vMinBounds.x,
    drawCall->m_Bounds.m_vMinBounds.y,
    drawCall->m_Bounds.m_vMinBounds.z);
  _Msg(
    a1: "                                     <%0.2f,%0.2f,%0.2f>\n",
    drawCall->m_Bounds.m_vMaxBounds.x,
    drawCall->m_Bounds.m_vMaxBounds.y,
    drawCall->m_Bounds.m_vMaxBounds.z);
  _Msg(a1: "  Resource bindings:                 %d\n", drawCall->m_nResourceBindings);
  _Msg(a1: "  Stage \t Slot \t Off \t Stride \t Resource\n");
  v2 = 0;
  if ( drawCall->m_nResourceBindings > 0 )
  {
    drawCalla = nullptr;
    do
    {
      v3 = (BVHResourceBinding_t *)((char *)drawCalla + (unsigned int)drawCall->m_pResourceBindings);
      _Msg(
        a1: "  %s \t %d \t %d \t %d \t %d\n",
        g_pStageName[v3->m_cBindStage],
        v3->m_cBindSlot,
        v3->m_nBindOffset,
        v3->m_nElementStride,
        v3->m_nResourceIndex);
      drawCalla = (CBVHDrawCall *)((char *)drawCalla + 16);
      ++v2;
    }
    while ( v2 < drawCall->m_nResourceBindings );
  }
  _Msg(a1: "  Params: \n");
  _Msg(
    a1: "  PrimType: %d, BaseVert %d, StartIndex %d, IndexCount %d\n",
    drawCall->m_nPrimitiveType,
    drawCall->m_nBaseVertex,
    drawCall->m_nVertexCount,
    drawCall->m_nStartIndex);
  if ( drawCall->m_nInstanceCount > 0 )
    _Msg(a1: "  StartInstance: %d, InstanceCount %d\n", drawCall->m_nStartInstance, drawCall->m_nInstanceCount);
}

//------------------------------------------------------------------------------
// Address: 0x00401C70
// Name: void DumpResource(int,int,class IResourceDictionary __near *)
// Source: json
//------------------------------------------------------------------------------
void __cdecl DumpResource(int nIndex, int nDictRes, IResourceDictionary *pDictionary)
{
  CBVHDictionaryEntry *v3; // esi
  int m_nResourceType; // ebx
  const ImageFormatInfo_t *v5; // eax
  Material_t materialData; // [esp+38h] [ebp-CCh] BYREF
  TextureHeader_t spec; // [esp+DCh] [ebp-28h] BYREF
  BVHBufferDesc_t desc; // [esp+F8h] [ebp-Ch] BYREF

  v3 = pDictionary->GetEntry(this: pDictionary, a2: nDictRes);
  m_nResourceType = v3->m_nResourceType;
  _Msg(
    a1: "  %d \t %d \t %s \t %s \t %d \t %d\n",
    nIndex,
    nDictRes,
    g_pResourceTypeName[m_nResourceType],
    g_pFlagsName[v3->m_Flags],
    LODWORD(v3->m_ChunkDesc.m_nOffset),
    HIDWORD(v3->m_ChunkDesc.m_nOffset));
  switch ( m_nResourceType )
  {
    case 0:
    case 1:
    case 2:
      if ( ((unsigned __int8 (__thiscall *)(IResourceDictionary *, BVHBufferDesc_t *, int, _DWORD, CBVHDictionaryEntry *))pDictionary->LoadEntrySerial)(
             a1: pDictionary,
             a2: &desc,
             a3: 12,
             a4: 0,
             a5: v3) == 0 )
        _Msg(a1: "Error loading entry!\n");
      _Msg(
        a1: "     Buffer Type: %d, Elements: %d, Stride: %d\n",
        desc.m_nBufferType,
        desc.m_nElementCount,
        desc.m_nElementSizeInBytes);
      break;
    case 3:
      if ( ((unsigned __int8 (__thiscall *)(IResourceDictionary *, TextureHeader_t *, int, _DWORD, CBVHDictionaryEntry *))pDictionary->LoadEntrySerial)(
             a1: pDictionary,
             a2: &spec,
             a3: 28,
             a4: 0,
             a5: v3) == 0 )
        _Msg(a1: "Error loading entry!\n");
      v5 = ImageLoader::ImageFormatInfo(fmt: (ImageFormat)spec.m_nImageFormat);
      _Msg(
        a1: "     H: %d, W: %d, D: %d, Mips: %d, Format: %s Reflectivity: %.2f %.2f %.2f\n",
        spec.m_nWidth,
        spec.m_nHeight,
        spec.m_nDepth,
        spec.m_nNumMipLevels,
        v5->m_pName,
        spec.m_Reflectivity.x,
        spec.m_Reflectivity.y,
        spec.m_Reflectivity.z);
      break;
    case 17:
      if ( ((unsigned __int8 (__thiscall *)(IResourceDictionary *, Material_t *, int, _DWORD, CBVHDictionaryEntry *))pDictionary->LoadEntrySerial)(
             a1: pDictionary,
             a2: &materialData,
             a3: 164,
             a4: 0,
        ...
        _Msg(a1: "Error loading entry!\n");
      _Msg(
        a1: "     VS: %s, PS: %s, AlphaTest: %d\n",
        materialData.m_szShaderVS,
        materialData.m_szShaderPS,
        materialData.m_bAlphaTest);
      break;
    default:
      return;
  }
...
//------------------------------------------------------------------------------
// Address: 0x00401E40
// Name: void DumpNode(class IWorldRenderer __near *,int)
// Source: json
//------------------------------------------------------------------------------
void __cdecl DumpNode(IWorldRenderer *pWorldRenderer, CBVHDrawCall *nNode)
{
  IBVHNode *v2; // esi
  int v3; // eax
  int v4; // eax
  ...
  int v10; // eax
  int j; // ebx
  double v12; // [esp+1Ch] [ebp-80h]
  double v13; // [esp+24h] [ebp-78h]
  _BYTE v14[24]; // [esp+38h] [ebp-64h] BYREF
  _BYTE v15[24]; // [esp+50h] [ebp-4Ch] BYREF
  TiledPosition_t v16; // [esp+68h] [ebp-34h] BYREF
  AABB_t bounds; // [esp+80h] [ebp-1Ch] BYREF
  IResourceDictionary *pDictionary; // [esp+98h] [ebp-4h]
  int nDrawCalls; // [esp+A4h] [ebp+8h]
  CBVHDrawCall *drawCall; // [esp+A8h] [ebp+Ch]
  CBVHDrawCall *drawCalla; // [esp+A8h] [ebp+Ch]

  pDictionary = pWorldRenderer->GetResourceDictionary(this: pWorldRenderer);
  if ( (int)nNode >= pWorldRenderer->GetNumNodes(this: pWorldRenderer) || (int)nNode < 0 )
  {
    _Msg(a1: "Invalid node index!\n");
  }
  else
  {
    v2 = pWorldRenderer->GetNode(this: pWorldRenderer, a2: nNode);
    _Msg(a1: "Node %d\n", nNode);
    _Msg(a1: "---------------------------------------------------------\n");
    v2->GetBounds(this: v2, result: &bounds);
    drawCall = (CBVHDrawCall *)v2->GetNumResources(this: v2);
    nDrawCalls = v2->GetNumDrawCalls(this: v2);
    v3 = v2->GetFlags(this: v2);
    _Msg(a1: "Flags:                               %d\n", v3);
    v4 = (int)v2->GetOrigin(this: v2, result: &v16);
    v5 = ((int (__thiscall *)(IBVHNode *, _BYTE *, _DWORD, _DWORD))v2->GetOrigin)(
           a1: v2,
           a2: v15,
           a3: COERCE_UNSIGNED_INT64(*(float *)(v4 + 20)),
           a4: HIDWORD(COERCE_UNSIGNED_INT64(*(float *)(v4 + 20))));
    v6 = ((int (__thiscall *)(IBVHNode *, _BYTE *, _DWORD, _DWORD))v2->GetOrigin)(
           a1: v2,
           a2: v14,
           a3: COERCE_UNSIGNED_INT64(*(float *)(v5 + 16)),
           a4: HIDWORD(COERCE_UNSIGNED_INT64(*(float *)(v5 + 16))));
    _Msg(a1: "Origin:                              <%0.2f,%0.2f,%0.2f>\n", *(float *)(v6 + 12), v12, v13);
    _Msg(
      a1: "Bounds:                              <%0.2f,%0.2f,%0.2f>\n",
      bounds.m_vMinBounds.x,
      bounds.m_vMinBounds.y,
      bounds.m_vMinBounds.z);
    _Msg(
      a1: "                                     <%0.2f,%0.2f,%0.2f>\n",
      bounds.m_vMaxBounds.x,
      bounds.m_vMaxBounds.y,
      bounds.m_vMaxBounds.z);
    v7 = ((double (__thiscall *)(IBVHNode *))v2->GetMinDistance)(a1: v2);
    _Msg(a1: "Minimum distance:                    %0.2f\n", v7);
    v8 = v2->GetNumChildren(this: v2);
    _Msg(a1: "Num children:                        %d\n", v8);
    _Msg(a1: "\n");
    _Msg(a1: "Num resources:                       %d\n", drawCall);
    _Msg(a1: "  Idx \t ID \t Type \t Flags \t Off \t Size\n");
    for ( i = 0; i < (int)drawCall; ++i )
    {
      v10 = v2->GetResourceIndex(this: v2, a2: i);
      DumpResource(nIndex: i, nDictRes: v10, pDictionary);
    }
    _Msg(a1: "\n");
    _Msg(a1: "Num draw calls:                      %d\n", nDrawCalls);
    for ( j = 0; j < nDrawCalls; ++j )
    {
      drawCalla = v2->GetDrawCall(this: v2, a2: j);
      _Msg(a1: "\n");
      DumpDrawCall(drawCall: drawCalla);
    }
  }
}
...
//------------------------------------------------------------------------------
// Address: 0x00402070
// Name: public: virtual int CDumpWorldApp::Main(void)
// Source: json
//------------------------------------------------------------------------------
// bad sp value at call has been detected, the output may be wrong!
int __usercall CDumpWorldApp::Main@<eax>(CDumpWorldApp *this@<ecx>, int a2@<ebx>, int a3@<edi>, int a4@<esi>)
{
  int v4; // eax
  const char *v5; // edi
  int v6; // eax
  ...
  int v10; // eax
  bool v11; // al
  IWorldRenderer *v12; // esi
  IResourceDictionary *v14; // eax
  const char *v15; // eax
  char pWorldFile360[260]; // [esp+2Ch] [ebp-314h] BYREF
  char pWorldFileTotal[260]; // [esp+130h] [ebp-210h] BYREF
  char pPageFile360[260]; // [esp+234h] [ebp-10Ch] BYREF
  int nDumpNode; // [esp+338h] [ebp-8h]
  bool bDump360File; // [esp+33Eh] [ebp-2h]
  bool bDumpNode; // [esp+33Fh] [ebp-1h]
  ...
  MathLib_Init(
    ...
    bAllowSSE2: true,
    bAllowMMX: true);
  v4 = _CommandLine(a1: a3, a2: a4, a3: a2);
  v5 = (const char *)(*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v4 + 32))(
                       a1: v4,
                       a2: "-world",
                       a3: 0);
  v6 = _CommandLine(a1: *(_DWORD *)pWorldFile360, a2: *(_DWORD *)&pWorldFile360[4], a3: *(_DWORD *)&pWorldFile360[8]);
  v7 = (*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v6 + 12))(a1: v6, a2: "-summary", a3: 0) != 0;
  v8 = _CommandLine(a1: *(_DWORD *)pWorldFile360, a2: *(_DWORD *)&pWorldFile360[4], a3: *(_DWORD *)&pWorldFile360[8]);
  bDumpNode = (*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v8 + 12))(a1: v8, a2: "-node", a3: 0) != 0;
  v9 = _CommandLine(a1: *(_DWORD *)pWorldFile360, a2: *(_DWORD *)&pWorldFile360[4], a3: *(_DWORD *)&pWorldFile360[8]);
  nDumpNode = (*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v9 + 28))(a1: v9, a2: "-node", a3: 0);
  v10 = _CommandLine(a1: *(_DWORD *)pWorldFile360, a2: *(_DWORD *)&pWorldFile360[4], a3: *(_DWORD *)&pWorldFile360[8]);
  v11 = (*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v10 + 12))(a1: v10, a2: "-dump360file", a3: 0) != 0;
  bDump360File = v11;
  if ( v5 != nullptr && (v7 || bDumpNode || v11) )
  {
    v12 = g_pWorldRendererMgr->CreateWorldRenderer(this: g_pWorldRendererMgr);
    V_snprintf(pDest: pWorldFileTotal, maxLen: 260, pFormat: "%s.whf", v5);
    if ( v12->Unserialize(this: v12, a2: pWorldFileTotal, a3: true) != 0 )
    {
      if ( v7 )
        DumpSummary(pWorldRenderer: v12);
      if ( bDumpNode )
        DumpNode(pWorldRenderer: v12, nNode: (CBVHDrawCall *)nDumpNode);
      if ( bDump360File )
      {
        V_snprintf(pDest: pWorldFile360, maxLen: 260, pFormat: "%s.360.whf", v5);
        v14 = v12->GetResourceDictionary(this: v12);
        v15 = (const char *)v14->GetPageFile(this: v14);
        V_StripExtension(in: v15, out: pPageFile360, outSize: 260);
        V_strncat(pDest: pPageFile360, pSrc: ".360.wrf", destBufferSize: 0x104u, max_chars_to_copy: -1);
        v12->WriteByteSwappedWorld(this: v12, a2: pWorldFile360, a3: pPageFile360);
      }
      g_pWorldRendererMgr->DestroyWorldRenderer(this: g_pWorldRendererMgr, a2: v12);
      return 1;
    }
    else
    {
  ...
  {
    _Msg(a1: "dumpworld usage:\n");
    _Msg(a1: "dumpworld.exe [options ] -world <worldfile>\n");
    _Msg(a1: "\n");
    _Msg(a1: "Options:\n");
    _Msg(a1: " -summary     : prints a summary of the world\n");
    _Msg(a1: " -node <int>  : dump information pertaining to a node\n");
    _Msg(a1: " -dump360file : dump an xbox 360 compatibile file\n");
    return 0;
  }
}
...
//------------------------------------------------------------------------------
// Address: 0x00402860
// Name: public: virtual char const __near * CDumpWorldApp::GetAppName(void)
// Source: json
//------------------------------------------------------------------------------
const char *__thiscall CDumpWorldApp::GetAppName(CDumpWorldApp *this)
{
  return "DumpWorld";
}
