...
// Original: utils/ps3/vxconsole_ps3/assert_dialog.cpp
// Functions: 2
// ============================================================
...
LABEL_14:
      ...
      return 1;
    case 0x110u:
      SetWindowTextA(hWnd: hDlg, lpString: "PS3 Assert!");
...
int __cdecl rc_Assert(char *commandPtr)
{
  ...
  FLASHWINFO flashWInfo; // [esp+4h] [ebp-20h] BYREF
  unsigned __int64 retAddr; // [esp+18h] [ebp-Ch] BYREF
  int xboxRetVal; // [esp+20h] [ebp-4h] BYREF
