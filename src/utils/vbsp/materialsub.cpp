...
// Original: utils/vbsp/materialsub.cpp
// Functions: 3
// ============================================================
...
// Source: json
//------------------------------------------------------------------------------
void __cdecl LoadMaterialReplacementKeys(const char *gamedir, const char *mapname)
{
  KeyValues *v2; // eax
         ...
         pfnEvaluateSymbolProc: nullptr) )
  {
    ...
    KeyValues::ChainKeyValue(this: allMapKeys, pChain: curMapKeys);
  }
  else
  {
...
// Source: json
//------------------------------------------------------------------------------
const char *__cdecl ReplaceMaterialName(const char *name)
{
