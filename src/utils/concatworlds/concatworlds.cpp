...
// Original: utils/concatworlds/concatworlds.cpp
// Functions: 46
// ============================================================

#include "utils\concatworlds\concatworlds.h"
...
//------------------------------------------------------------------------------
// Address: 0x00401020
// Name: public: virtual bool CBakeWorldApp::Create(void)
// Source: json
//------------------------------------------------------------------------------
bool __thiscall CBakeWorldApp::Create(CBakeWorldApp *this)
{
...
//------------------------------------------------------------------------------
// Address: 0x00401060
// Name: private: bool CBakeWorldApp::SetupSearchPaths(void)
// Source: json
//------------------------------------------------------------------------------
bool __thiscall CBakeWorldApp::SetupSearchPaths(CBakeWorldApp *this)
{
  bool result; // al
...
//------------------------------------------------------------------------------
// Address: 0x004010C0
// Name: public: virtual bool CBakeWorldApp::PreInit(void)
// Source: json
//------------------------------------------------------------------------------
char __thiscall CBakeWorldApp::PreInit(CBakeWorldApp *this)
{
  ...
  if ( g_pFullFileSystem == nullptr || g_pWorldRendererMgr == nullptr )
    return 0;
  if ( !CBakeWorldApp::SetupSearchPaths(this) )
...
//------------------------------------------------------------------------------
// Address: 0x00401130
// Name: public: virtual void CBakeWorldApp::PostShutdown(void)
// Source: json
//------------------------------------------------------------------------------
void __thiscall CBakeWorldApp::PostShutdown(CBakeWorldApp *this)
{
...
//------------------------------------------------------------------------------
// Address: 0x00401140
// Name: public: struct BVHBuilderParams_t __near & BVHBuilderParams_t::operator=(struct BVHBuilderParams_t const __near &)
// Source: json
//------------------------------------------------------------------------------
BVHBuilderParams_t *__thiscall BVHBuilderParams_t::operator=(
        BVHBuilderParams_t *this,
        const BVHBuilderParams_t *__that)
{
  *this = *__that;
  return this;
}
...
//------------------------------------------------------------------------------
// Address: 0x004011E0
// Name: public: void CUtlMemory<struct CWorldRep,int>::Grow(int)
// Source: json
//------------------------------------------------------------------------------
void __thiscall CUtlMemory<CWorldRep,int>::Grow(CUtlMemory<CWorldRep,int> *this, int num)
{
  int m_nGrowSize; // esi
  int m_nAllocationCount; // eax
  int v5; // ecx
  CWorldRep *m_pMemory; // edx
...
LABEL_13:
    ...
    if ( m_pMemory != nullptr )
      this->m_pMemory = (CWorldRep *)_g_pMemAlloc->Realloc_2(this: _g_pMemAlloc, a2: m_pMemory, a3: v7);
    else
      this->m_pMemory = (CWorldRep *)_g_pMemAlloc->Alloc_2(this: _g_pMemAlloc, a2: v7);
  }
}

//------------------------------------------------------------------------------
// Address: 0x00401280
// Name: bool FindMatchingLandmarks(class Vector __near *,class Vector __near *,class CUtlVector<class KeyValues __near *,class CUtlMemory<class KeyValues __near *,int>> __near &,class CUtlVector<class KeyValues __near *,class CUtlMemory<class KeyValues __near *,int>> __near &)
// Source: json
//------------------------------------------------------------------------------
char __cdecl FindMatchingLandmarks(
        Vector *pFrom,
        Vector *pTo,
        CUtlVector<KeyValues *,CUtlMemory<KeyValues *,int> > *from,
        CUtlVector<KeyValues *,CUtlMemory<KeyValues *,int> > *to)
{
  int v4; // esi
  ...
  {
    v4 = 0;
    String = KeyValues::GetString(this: from->m_Memory.m_pMemory[f], keyName: "targetname", defaultValue: setName);
    if ( to->m_Size > 0 )
      break;
LABEL_5:
    if ( ++f >= from->m_Size )
  ...
  while ( 1 )
  {
    v6 = KeyValues::GetString(this: to->m_Memory.m_pMemory[v4], keyName: "targetname", defaultValue: setName);
    if ( _V_stricmp(s1: String, s2: v6) == 0 )
      break;
    if ( ++v4 >= to->m_Size )
      goto LABEL_5;
  }
  v8 = KeyValues::GetString(this: from->m_Memory.m_pMemory[f], keyName: "origin", defaultValue: setName);
  v9 = KeyValues::GetString(this: to->m_Memory.m_pMemory[v4], keyName: "origin", defaultValue: setName);
  sscanf(string: v8, format: "%f %f %f", pFrom, &pFrom->y, &pFrom->z);
  sscanf(string: v9, format: "%f %f %f", pTo, &pTo->y, &pTo->z);
  return 1;
}
...
//------------------------------------------------------------------------------
// Address: 0x004018E0
// Name: public: virtual int CBakeWorldApp::Main(void)
// Source: json
//------------------------------------------------------------------------------
int __usercall CBakeWorldApp::Main@<eax>(CBakeWorldApp *this@<ecx>, int a2@<ebx>, int a3@<edi>, int a4@<esi>)
{
  int (*v4)(void); // edi
  int v5; // eax
  int v6; // eax
  ...
  const char *v15; // esi
  int v16; // ebx
  int **p_pResourceRemap; // esi
  int v18; // esi
  CBVHDictionaryEntry *v19; // eax
  unsigned int m_nSize_high; // ecx
  unsigned int m_nSize; // edi
  int v22; // eax
  int v23; // edi
  IWorldRenderer **p_pWorldRenderer; // esi
  int v25; // eax
  int v26; // eax
  int v27; // eax
  int v28; // eax
  ...
  __int64 v54; // rax
  int v55; // eax
  IWorldRenderer *v56; // ecx
  void *v57; // esi
  IWorldRenderer **v58; // ebx
  IWorldRenderer **v59; // edi
  IWorldRenderer **v60; // edi
  IBVHNode *v61; // eax
  IWorldRenderer **v62; // edi
  int v63; // esi
  IResourceDictionary **v64; // eax
  int *v65; // eax
  CBVHDictionaryEntry *v66; // eax
  CWorldRep *m_pMemory; // edi
  CWorldRep *v69; // esi
  IWorldRenderer *v70; // eax
  int v71; // edi
  IWorldRenderer *pWorldRenderer; // ecx
  IWorldRenderer_vtbl *v73; // edx
  int v74; // eax
  int v75; // ebx
  int v76; // eax
  KeyValues **v77; // ecx
  ...
  int v79; // eax
  int v80; // edx
  IWorldRenderer *v81; // ecx
  IWorldRenderer_vtbl *v82; // eax
  unsigned __int64 v83; // kr08_8
  int v84; // eax
  int v85; // ebx
  CWorldRep *v86; // esi
  void *v87; // eax
  ...
  void *v91; // eax
  KeyValues **v92; // eax
  CWorldRep world; // [esp+2Ch] [ebp-55Ch] BYREF
  char pHierFileName[260]; // [esp+18Ch] [ebp-3FCh] BYREF
  char pResFileName[260]; // [esp+290h] [ebp-2F8h] BYREF
  char v97[12]; // [esp+394h] [ebp-1F4h] BYREF
  Vector vFrom; // [esp+3A0h] [ebp-1E8h] BYREF
  CUtlStringMap<int> instancedEntries; // [esp+3ACh] [ebp-1DCh] BYREF
  BVHChunkDescriptor_t hierChunk; // [esp+3F8h] [ebp-190h] BYREF
  CUtlBuffer buffer; // [esp+410h] [ebp-178h] BYREF
  Vector vTo; // [esp+440h] [ebp-148h] BYREF
  HierarchyChunkHeader_t hierHeader; // [esp+44Ch] [ebp-13Ch] BYREF
  BVHChunkDescriptor_t entityChunk; // [esp+458h] [ebp-130h] BYREF
  BVHChunkDescriptor_t dictChunk; // [esp+470h] [ebp-118h] BYREF
  BVHNodeHeader_t rootNodeHeader; // [esp+488h] [ebp-100h] BYREF
  int nAtlasTextureSizeY; // [esp+4D4h] [ebp-B4h]
  EntityChunkHeader_t entityHeader; // [esp+4D8h] [ebp-B0h] BYREF
  Vector vCurrentDelta; // [esp+4DCh] [ebp-ACh] BYREF
  CUtlVector<IResourceDictionary *,CUtlMemory<IResourceDictionary *,int> > dictionaryList; // [esp+4E8h] [ebp-A0h] BYREF
  int nTotalEntityChunkSize; // [esp+4FCh] [ebp-8Ch]
  int nMaxNodeSizeBytes; // [esp+500h] [ebp-88h]
  CUtlVector<KeyValues *,CUtlMemory<KeyValues *,int> > lastLandmarks; // [esp+504h] [ebp-84h] BYREF
  Vector vOriginShift; // [esp+518h] [ebp-70h]
  unsigned __int64 nResSize; // [esp+524h] [ebp-64h]
  CUtlVector<CBVHDictionaryEntry,CUtlMemory<CBVHDictionaryEntry,int> > dictionaryEntries; // [esp+52Ch] [ebp-5Ch] BYREF
  float v117; // [esp+540h] [ebp-48h] BYREF
  CUtlVector<KeyValues *,CUtlMemory<KeyValues *,int> > curLandmarks; // [esp+544h] [ebp-44h] BYREF
  int nAvgNodeSizeBytes; // [esp+558h] [ebp-30h]
  int nTotalResources; // [esp+55Ch] [ebp-2Ch]
  unsigned __int64 nID; // [esp+560h] [ebp-28h] BYREF
  CUtlVector<CWorldRep,CUtlMemory<CWorldRep,int> > InputWorlds; // [esp+568h] [ebp-20h] BYREF
  int w; // [esp+57Ch] [ebp-Ch]
  int r; // [esp+580h] [ebp-8h]
  void *fpNew; // [esp+584h] [ebp-4h]
  ...
  MathLib_Init(
    ...
    bAllowSSE2: true,
    bAllowMMX: true);
  v4 = (int (*)(void))_CommandLine;
  memset(&InputWorlds, 0, sizeof(InputWorlds));
  v5 = _CommandLine(a1: a3, a2: a4, a3: a2);
  nTotalResources = (*(int (__thiscall **)(int, const char *, _DWORD))(*(_DWORD *)v5 + 32))(
                      a1: v5,
                      a2: "-worldout",
                      a3: 0);
  v6 = _CommandLine(
         a1: *(_DWORD *)world.pWorldFile,
         a2: *(_DWORD *)&world.pWorldFile[4],
         a3: *(_DWORD *)&world.pWorldFile[8]);
  v7 = (*(int (__thiscall **)(int, const char *))(*(_DWORD *)v6 + 40))(a1: v6, a2: "-worldout") + 2;
  v8 = _CommandLine(
         a1: *(_DWORD *)world.pWorldFile,
         a2: *(_DWORD *)&world.pWorldFile[4],
         a3: *(_DWORD *)&world.pWorldFile[8]);
  if ( v7 >= (*(int (__thiscall **)(int))(*(_DWORD *)v8 + 36))(a1: v8) )
    goto LABEL_140;
  do
  {
    v9 = v4();
    v10 = (const char *)(*(int (__thiscall **)(int, int))(*(_DWORD *)v9 + 44))(a1: v9, a2: v7);
    V_snprintf(pDest: world.pWorldFile, maxLen: 260, pFormat: "maps/%s.whf", v10);
    m_Size = InputWorlds.m_Size;
    if ( InputWorlds.m_Size + 1 > InputWorlds.m_Memory.m_nAllocationCount )
      CUtlMemory<CWorldRep,int>::Grow(
        this: &InputWorlds.m_Memory,
        num: InputWorlds.m_Size - InputWorlds.m_Memory.m_nAllocationCount + 1);
    ++InputWorlds.m_Size;
    InputWorlds.m_pElements = InputWorlds.m_Memory.m_pMemory;
    if ( InputWorlds.m_Size - m_Size - 1 > 0 )
      _V_memmove(
        dest: &InputWorlds.m_Memory.m_pMemory[m_Size + 1],
        src: &InputWorlds.m_Memory.m_pMemory[m_Size],
        count: 352 * (InputWorlds.m_Size - m_Size - 1));
    v12 = &InputWorlds.m_Memory.m_pMemory[m_Size];
    if ( v12 != nullptr )
    {
      *v12 = world;
      v4 = (int (*)(void))_CommandLine;
  ...
  while ( v7 < (*(int (__thiscall **)(int))(*(_DWORD *)v13 + 36))(a1: v13) );
  v14 = InputWorlds.m_Size;
  if ( InputWorlds.m_Size >= 2 && (v15 = (const char *)nTotalResources, v16 = 0, nTotalResources != 0) )
  {
    CUtlBuffer::CUtlBuffer(this: &buffer, growSize: 0, initSize: 0, nFlags: 1);
    CUtlBuffer::EnsureCapacity(this: &buffer, num: 0x40000);
    nMaxNodeSizeBytes = 0;
    nAvgNodeSizeBytes = 0;
    nTotalEntityChunkSize = 0;
    memset(&vCurrentDelta, 0, sizeof(vCurrentDelta));
    memset(&lastLandmarks, 0, sizeof(lastLandmarks));
    w = 0;
    if ( v14 <= 0 )
      goto LABEL_12;
    while ( 1 )
    {
      m_pMemory = InputWorlds.m_Memory.m_pMemory;
      v69 = &InputWorlds.m_Memory.m_pMemory[v16];
      v70 = g_pWorldRendererMgr->CreateWorldRenderer(this: g_pWorldRendererMgr);
      v69->pWorldRenderer = v70;
      if ( v70->Unserialize(this: v70, a2: v69->pWorldFile, a3: true) == 0 )
      {
        _Error(a1: "Cannot load %s!\n", m_pMemory[v16].pWorldFile);
        if ( lastLandmarks.m_Memory.m_nGrowSize >= 0 && lastLandmarks.m_Memory.m_pMemory != nullptr )
          _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: lastLandmarks.m_Memory.m_pMemory);
        ...
        if ( InputWorlds.m_Memory.m_nGrowSize >= 0 && m_pMemory != nullptr )
          _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: m_pMemory);
        return 0;
      }
      v71 = (int)v69->pWorldRenderer->GetHeader(this: v69->pWorldRenderer);
      memset(&curLandmarks, 0, sizeof(curLandmarks));
      v69->pWorldRenderer->GetEntities_2(this: v69->pWorldRenderer, a2: "info_landmark", a3: &curLandmarks, a4: nullptr);
      if ( v16 > 0 )
      {
        if ( FindMatchingLandmarks(pFrom: &vFrom, pTo: &vTo, from: &lastLandmarks, to: &curLandmarks) != 0 )
        {
          pWorldRenderer = v69->pWorldRenderer;
          v73 = pWorldRenderer->__vftable;
          vOriginShift.x = (float)(vTo.x - vFrom.x) + vCurrentDelta.x;
          vOriginShift.y = (float)(vTo.y - vFrom.y) + vCurrentDelta.y;
          vOriginShift.z = (float)(vTo.z - vFrom.z) + vCurrentDelta.z;
          ((void (__thiscall *)(IWorldRenderer *, _DWORD, _DWORD, _DWORD))v73->ShiftOrigins)(
            a1: pWorldRenderer,
            a2: LODWORD(vOriginShift.x),
            a3: LODWORD(vOriginShift.y),
            a4: LODWORD(vOriginShift.z));
          vCurrentDelta = vOriginShift;
        }
        else
        {
          _Warning(a1: "Cannot find matching landmarks between worlds!\n");
        }
      }
      v74 = 0;
      v75 = curLandmarks.m_Size;
      lastLandmarks.m_Size = 0;
      if ( curLandmarks.m_Size != 0 )
      {
        if ( curLandmarks.m_Size > lastLandmarks.m_Memory.m_nAllocationCount )
        {
          CUtlMemory<CUtlSymbolTable::StringPool_t *,int>::Grow(
            this: (CUtlMemory<CUtlSymbolTable::StringPool_t *,int> *)&lastLandmarks,
            num: curLandmarks.m_Size - lastLandmarks.m_Memory.m_nAllocationCount);
          v74 = lastLandmarks.m_Size;
        }
        lastLandmarks.m_Size = v75 + v74;
        lastLandmarks.m_pElements = lastLandmarks.m_Memory.m_pMemory;
        if ( v74 > 0 && v75 > 0 )
          _V_memmove(
            dest: &lastLandmarks.m_Memory.m_pMemory[v75],
            src: lastLandmarks.m_Memory.m_pMemory,
            count: 4 * v74);
      }
      v76 = 0;
      if ( v75 > 0 )
      {
        v77 = lastLandmarks.m_Memory.m_pMemory;
        do
        {
          v77[v76] = curLandmarks.m_Memory.m_pMemory[v76];
          ++v76;
        }
        while ( v76 < v75 );
      }
      v69->pDictionary = v69->pWorldRenderer->GetResourceDictionary(this: v69->pWorldRenderer);
      BVHBuilderParams_t::operator=(this: &v69->params, __that: (const BVHBuilderParams_t *)(v71 + 20));
      v78 = v69->pDictionary->GetNumResources(this: v69->pDictionary);
      v69->nOriginalResources = v78;
      v69->pResourceRemap = (int *)operator new(nSize: 4 * v78);
      v69->pWorldRenderer->GetNumNodes(this: v69->pWorldRenderer);
      v79 = v69->pWorldRenderer->GetChunkSize(this: v69->pWorldRenderer, a2: CHUNK_TYPE_ENTITIES);
      v80 = nTotalEntityChunkSize + v79 - 20;
      v81 = v69->pWorldRenderer;
      v82 = v81->__vftable;
      nTotalEntityChunkSize = v80;
      v83 = v82->GetMaxNodeSizeBytes(this: v81);
      if ( v83 > nMaxNodeSizeBytes )
        nMaxNodeSizeBytes = v69->pWorldRenderer->GetMaxNodeSizeBytes(this: v69->pWorldRenderer);
      v84 = v69->pWorldRenderer->GetAvgNodeSizeBytes(this: v69->pWorldRenderer);
      v85 = w;
      nAvgNodeSizeBytes += v84;
      if ( w != 0 )
      {
        v91 = (void *)v69->pDictionary->GetNumLayoutDescs(this: v69->pDictionary);
        if ( fpNew != v91 )
        {
          _Error(a1: "Input layouts do not match between worlds!\n");
          CUtlVector<void (__cdecl *)(IConVar *,char const *,float),CUtlMemory<void (__cdecl *)(IConVar *,char const *,float),int>>::~CUtlVector<void (__cdecl *)(IConVar *,char const *,float),CUtlMemory<void (__cdecl *)(IConVar *,char const *,float),int>>(this: (CUtlVector<CUtlSymbolTable::StringPool_t *,CUtlMemory<CUtlSymbolTable::StringPool_t *,int> > *)&curLandmarks);
          CUtlVector<void (__cdecl *)(IConVar *,char const *,float),CUtlMemory<void (__cdecl *)(IConVar *,char const *,float),int>>::~CUtlVector<void (__cdecl *)(IConVar *,char const *,float),CUtlMemory<void (__cdecl *)(IConVar *,char const *,float),int>>(this: (CUtlVector<CUtlSymbolTable::StringPool_t *,CUtlMemory<CUtlSymbolTable::StringPool_t *,int> > *)&lastLandmarks);
          if ( buffer.m_Memory.m_nGrowSize >= 0 )
          {
            if ( buffer.m_Memory.m_pMemory != nullptr )
            {
          ...
          CUtlVector<void (__cdecl *)(IConVar *,char const *,float),CUtlMemory<void (__cdecl *)(IConVar *,char const *,float),int>>::~CUtlVector<void (__cdecl *)(IConVar *,char const *,float),CUtlMemory<void (__cdecl *)(IConVar *,char const *,float),int>>(this: (CUtlVector<CUtlSymbolTable::StringPool_t *,CUtlMemory<CUtlSymbolTable::StringPool_t *,int> > *)&InputWorlds);
          return 0;
        }
        if ( r != v69->params.m_nAtlasTextureSizeX || nAtlasTextureSizeY != v69->params.m_nAtlasTextureSizeY )
          _Warning(a1: "Atlas texture sizes do not match!  This can cause performance problems!\n");
        if ( __PAIR64__(HIDWORD(nID), HIDWORD(nResSize)) != *(_QWORD *)&v69->params.m_nUniqueTextureSizeX )
          _Warning(a1: "Unique texture sizes do not match!  This can cause performance problems!\n");
      }
      else
      {
        v86 = InputWorlds.m_Memory.m_pMemory;
        v87 = (void *)InputWorlds.m_Memory.m_pMemory->pDictionary->GetNumLayoutDescs(this: InputWorlds.m_Memory.m_pMemory->pDictionary);
        m_nAtlasTextureSizeY = v86->params.m_nAtlasTextureSizeY;
        m_nUniqueTextureSizeX = v86->params.m_nUniqueTextureSizeX;
        fpNew = v87;
        r = v86->params.m_nAtlasTextureSizeX;
        m_nUniqueTextureSizeY = v86->params.m_nUniqueTextureSizeY;
        nAtlasTextureSizeY = m_nAtlasTextureSizeY;
        HIDWORD(nResSize) = m_nUniqueTextureSizeX;
        HIDWORD(nID) = m_nUniqueTextureSizeY;
      }
      v92 = curLandmarks.m_Memory.m_pMemory;
      curLandmarks.m_Size = 0;
      if ( curLandmarks.m_Memory.m_nGrowSize >= 0 )
      {
        if ( curLandmarks.m_Memory.m_pMemory != nullptr )
        {
          _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: curLandmarks.m_Memory.m_pMemory);
          v92 = nullptr;
          curLandmarks.m_Memory.m_pMemory = nullptr;
        }
        curLandmarks.m_Memory.m_nAllocationCount = 0;
      }
      curLandmarks.m_pElements = v92;
      if ( curLandmarks.m_Memory.m_nGrowSize >= 0 && v92 != nullptr )
        _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: v92);
      w = v85 + 1;
      if ( v85 + 1 >= InputWorlds.m_Size )
        break;
      v16 = w;
    }
    v15 = (const char *)nTotalResources;
    v14 = InputWorlds.m_Size;
    v16 = 0;
LABEL_12:
    nAvgNodeSizeBytes /= v14;
    V_snprintf(pDest: pHierFileName, maxLen: 260, pFormat: "maps/%s.whf", v15);
    V_snprintf(pDest: pResFileName, maxLen: 260, pFormat: "maps/%s.wrf", v15);
    memset(&dictionaryEntries, 0, sizeof(dictionaryEntries));
    instancedEntries.m_Vector.m_Memory.m_pMemory = nullptr;
    instancedEntries.m_Vector.m_Memory.m_nAllocationCount = 0;
    instancedEntries.m_Vector.m_Memory.m_nGrowSize = 32;
    instancedEntries.m_Vector.m_Size = 0;
    instancedEntries.m_Vector.m_pElements = nullptr;
    CUtlSymbolTable::CUtlSymbolTable(
      this: &instancedEntries.m_SymbolTable,
      growSize: 0,
      initSize: 32,
      caseInsensitive: true);
    memset(&dictionaryList, 0, sizeof(dictionaryList));
    if ( v14 > 0 )
    {
      p_pResourceRemap = &InputWorlds.m_Memory.m_pMemory->pResourceRemap;
      do
      {
        (*(void (__thiscall **)(_DWORD, CUtlVector<CBVHDictionaryEntry,CUtlMemory<CBVHDictionaryEntry,int> > *, CUtlVector<IResourceDictionary *,CUtlMemory<IResourceDictionary *,int> > *, CUtlStringMap<int> *, int *))(**(p_pResourceRemap - 21) + 60))(
          a1: *(p_pResourceRemap - 21),
          a2: &dictionaryEntries,
          a3: &dictionaryList,
          a4: &instancedEntries,
          a5: *p_pResourceRemap);
        p_pResourceRemap += 88;
    ...
    fpNew = g_pFullFileSystem->Open(this: &g_pFullFileSystem->IBaseFileSystem, a2: pResFileName, a3: "wb", a4: 0);
    nTotalResources = dictionaryEntries.m_Size;
    w = 0;
    nID = 0;
    r = 0;
    if ( dictionaryEntries.m_Size > 0 )
    {
      v18 = 0;
      while ( 1 )
      {
        v19 = dictionaryEntries.m_Memory.m_pMemory;
        m_nSize_high = HIDWORD(dictionaryEntries.m_Memory.m_pMemory[v18].m_ChunkDesc.m_nSize);
        m_nSize = dictionaryEntries.m_Memory.m_pMemory[v18].m_ChunkDesc.m_nSize;
        HIDWORD(nResSize) = m_nSize_high;
        if ( v16 == 0 )
          goto LABEL_20;
        if ( nID < __PAIR64__(m_nSize_high, m_nSize) )
          break;
LABEL_21:
        if ( ((unsigned __int8 (__thiscall *)(IResourceDictionary *, int, unsigned int, _DWORD, CBVHDictionaryEntry *))dictionaryList.m_Memory.m_pMemory[r]->LoadEntrySerial)(
               a1: dictionaryList.m_Memory.m_pMemory[r],
               a2: v16,
               a3: m_nSize,
               a4: HIDWORD(nResSize),
               a5: &v19[v18]) == 0 )
          _Error(a1: "Could not load resource %s!\n", dictionaryEntries.m_Memory.m_pMemory[v18].m_pName);
        ...
        v22 = w;
        w += m_nSize;
        dictionaryEntries.m_Memory.m_pMemory[v18++].m_ChunkDesc.m_nOffset = v22;
        if ( ++r >= nTotalResources )
        {
          if ( v16 != 0 )
            free(pMem: (void *)v16);
          goto LABEL_26;
      ...
      free(pMem: (void *)v16);
LABEL_20:
      v16 = (int)operator new(nSize: m_nSize);
      v19 = dictionaryEntries.m_Memory.m_pMemory;
      nID = __PAIR64__(HIDWORD(nResSize), m_nSize);
      goto LABEL_21;
    }
LABEL_26:
    g_pFullFileSystem->Close(this: &g_pFullFileSystem->IBaseFileSystem, a2: fpNew);
    rootNodeHeader.m_Bounds.m_vMinBounds.x = 3.4028235e38;
    rootNodeHeader.m_Bounds.m_vMinBounds.y = 3.4028235e38;
    rootNodeHeader.m_Bounds.m_vMinBounds.z = 3.4028235e38;
    rootNodeHeader.m_flMinimumDistance = 3.4028235e38;
    v23 = 1;
    rootNodeHeader.m_Bounds.m_vMaxBounds.x = -3.4028235e38;
    rootNodeHeader.m_Bounds.m_vMaxBounds.y = -3.4028235e38;
    rootNodeHeader.m_Bounds.m_vMaxBounds.z = -3.4028235e38;
    rootNodeHeader.m_Flags = 16;
    rootNodeHeader.m_nChildren = InputWorlds.m_Size;
    rootNodeHeader.m_nDrawCalls = 0;
    rootNodeHeader.m_nID = 0;
    rootNodeHeader.m_nResources = 0;
    memset(&rootNodeHeader.m_Origin, 0, sizeof(rootNodeHeader.m_Origin));
    r = 1;
    if ( InputWorlds.m_Size > 0 )
    {
      p_pWorldRenderer = &InputWorlds.m_Memory.m_pMemory->pWorldRenderer;
      for ( fpNew = (void *)InputWorlds.m_Size; fpNew != nullptr; fpNew = (char *)fpNew - 1 )
      {
        (*p_pWorldRenderer)->ShiftNodes(this: *p_pWorldRenderer, a2: v23, a3: (int *)p_pWorldRenderer[22]);
        v25 = (int)(*p_pWorldRenderer)->GetNode(this: *p_pWorldRenderer, a2: 0);
        (*(void (__thiscall **)(int, _DWORD))(*(_DWORD *)v25 + 64))(a1: v25, a2: 0);
        v26 = (int)(*p_pWorldRenderer)->GetNode(this: *p_pWorldRenderer, a2: 0);
        (*(void (__thiscall **)(int, float *))(*(_DWORD *)v26 + 16))(a1: v26, a2: &v117);
        v27 = (int)(*p_pWorldRenderer)->GetNode(this: *p_pWorldRenderer, a2: 0);
        v28 = (*(int (__thiscall **)(int, char *))(*(_DWORD *)v27 + 12))(a1: v27, a2: v97);
        v29 = *(_QWORD *)(v28 + 12);
        v30 = *(float *)(v28 + 20);
        *(_QWORD *)&vOriginShift.x = v29;
        v31 = *(float *)&curLandmarks.m_Memory.m_pMemory - *((float *)&v29 + 1);
        v32 = *(float *)&curLandmarks.m_Memory.m_nGrowSize - *(float *)&v29;
        v33 = *(float *)&curLandmarks.m_Size - *((float *)&v29 + 1);
        vOriginShift.z = v30;
        v34 = *(float *)&curLandmarks.m_Memory.m_nAllocationCount - v30;
        v35 = *(float *)&curLandmarks.m_pElements - v30;
        v117 = v117 - *(float *)&v29;
        x = v117;
        *(float *)&curLandmarks.m_Memory.m_pMemory = *(float *)&curLandmarks.m_Memory.m_pMemory - vOriginShift.y;
        *(float *)&curLandmarks.m_Memory.m_nAllocationCount = *(float *)&curLandmarks.m_Memory.m_nAllocationCount - v30;
        *(float *)&curLandmarks.m_Memory.m_nGrowSize = *(float *)&curLandmarks.m_Memory.m_nGrowSize - vOriginShift.x;
        *(float *)&curLandmarks.m_Size = *(float *)&curLandmarks.m_Size - vOriginShift.y;
        *(float *)&curLandmarks.m_pElements = *(float *)&curLandmarks.m_pElements - v30;
        if ( v117 > (double)rootNodeHeader.m_Bounds.m_vMinBounds.x )
          x = rootNodeHeader.m_Bounds.m_vMinBounds.x;
        v37 = x;
        rootNodeHeader.m_Bounds.m_vMinBounds.x = v37;
        y = v31;
        if ( v31 > (double)rootNodeHeader.m_Bounds.m_vMinBounds.y )
          y = rootNodeHeader.m_Bounds.m_vMinBounds.y;
        v39 = y;
        rootNodeHeader.m_Bounds.m_vMinBounds.y = v39;
        z = v34;
        if ( v34 > (double)rootNodeHeader.m_Bounds.m_vMinBounds.z )
          z = rootNodeHeader.m_Bounds.m_vMinBounds.z;
        v41 = z;
        rootNodeHeader.m_Bounds.m_vMinBounds.z = v41;
        v42 = v32;
        if ( v32 < (double)rootNodeHeader.m_Bounds.m_vMaxBounds.x )
          v42 = rootNodeHeader.m_Bounds.m_vMaxBounds.x;
        v43 = v42;
        rootNodeHeader.m_Bounds.m_vMaxBounds.x = v43;
        v44 = v33;
        if ( v33 < (double)rootNodeHeader.m_Bounds.m_vMaxBounds.y )
          v44 = rootNodeHeader.m_Bounds.m_vMaxBounds.y;
        v45 = v44;
        rootNodeHeader.m_Bounds.m_vMaxBounds.y = v45;
        v46 = v35;
        if ( v35 < (double)rootNodeHeader.m_Bounds.m_vMaxBounds.z )
          v46 = rootNodeHeader.m_Bounds.m_vMaxBounds.z;
        rootNodeHeader.m_Bounds.m_vMaxBounds.z = v46;
        v23 += (*p_pWorldRenderer)->GetNumNodes(this: *p_pWorldRenderer);
        p_pWorldRenderer += 88;
      }
      r = v23;
    }
    v47 = InputWorlds.m_Size;
    v48 = 4 * rootNodeHeader.m_nChildren + 88;
    nID = (unsigned int)v48;
    if ( InputWorlds.m_Size > 0 )
    {
      v49 = &InputWorlds.m_Memory.m_pMemory->pWorldRenderer;
      do
      {
        v50 = (*v49)->GetChunkSize(this: *v49, a2: CHUNK_TYPE_HEIRARCHY);
        v51 = (v50 - 12 + __PAIR64__(HIDWORD(nID), v48)) >> 32;
        v48 += v50 - 12;
        HIDWORD(nID) = v51;
        v49 += 88;
        --v47;
    ...
    v52 = InputWorlds.m_Memory.m_pMemory;
    v53 = 104 * nTotalResources;
    v54 = (unsigned int)v53
        + (__int64)InputWorlds.m_Memory.m_pMemory->pDictionary->GetNonEntryDataSize(this: InputWorlds.m_Memory.m_pMemory->pDictionary);
    HIDWORD(nResSize) = HIDWORD(v54);
    HIDWORD(v54) = g_pFullFileSystem->Open;
    LODWORD(nResSize) = v54;
    v55 = ((int (__thiscall *)(IBaseFileSystem *, char *, const char *, _DWORD))HIDWORD(v54))(
            a1: &g_pFullFileSystem->IBaseFileSystem,
            a2: pHierFileName,
            a3: "wb",
            a4: 0);
    v56 = v52->pWorldRenderer;
    v57 = (void *)v55;
    v58 = &v52->pWorldRenderer;
    v56->WriteHeaderData(this: v56, a2: 3, a3: (void *)v55);
    dictChunk.m_nChunkType = CHUNK_TYPE_RESOURCE_DICTIONARY;
    dictChunk.m_nSize = nResSize;
    dictChunk.m_nOffset = 168;
    (*v58)->WriteChunkDesc(this: *v58, a2: &dictChunk, a3: v57);
    entityChunk.m_nOffset = dictChunk.m_nOffset + dictChunk.m_nSize;
    entityChunk.m_nSize = (unsigned int)(nTotalEntityChunkSize + 20);
    entityChunk.m_nChunkType = CHUNK_TYPE_ENTITIES;
    (*v58)->WriteChunkDesc(this: *v58, a2: &entityChunk, a3: v57);
    hierChunk.m_nOffset = entityChunk.m_nOffset + entityChunk.m_nSize;
    hierChunk.m_nSize = nID;
    hierChunk.m_nChunkType = CHUNK_TYPE_HEIRARCHY;
    (*v58)->WriteChunkDesc(this: *v58, a2: &hierChunk, a3: v57);
    InputWorlds.m_Memory.m_pMemory->pDictionary->WriteNonEntryData(
      this: InputWorlds.m_Memory.m_pMemory->pDictionary,
      a2: nTotalResources,
      a3: pResFileName,
      a4: v57);
    g_pFullFileSystem->Write(
      this: &g_pFullFileSystem->IBaseFileSystem,
      a2: dictionaryEntries.m_Memory.m_pMemory,
      a3: v53,
      a4: v57);
    entityHeader.m_nEntities = 0;
    g_pFullFileSystem->Write(this: &g_pFullFileSystem->IBaseFileSystem, a2: &entityHeader, a3: 4, a4: v57);
    g_pFullFileSystem->Write(this: &g_pFullFileSystem->IBaseFileSystem, a2: "\"Entities\"\n{\n", a3: 13, a4: v57);
    if ( InputWorlds.m_Size > 0 )
    {
      v59 = v58;
      for ( fpNew = (void *)InputWorlds.m_Size; fpNew != nullptr; fpNew = (char *)fpNew - 1 )
      {
        (*v59)->WriteNonTerminatedEntityChunk(this: *v59, a2: v57);
        v59 += 88;
      }
    }
    g_pFullFileSystem->Write(this: &g_pFullFileSystem->IBaseFileSystem, a2: "}\n", a3: 3, a4: v57);
    hierHeader.m_nNodes = r;
    hierHeader.m_nMaxNodeSizeBytes = nMaxNodeSizeBytes;
    hierHeader.m_nAvgNodeSizeBytes = nAvgNodeSizeBytes;
    g_pFullFileSystem->Write(this: &g_pFullFileSystem->IBaseFileSystem, a2: &hierHeader, a3: 12, a4: v57);
    g_pFullFileSystem->Write(this: &g_pFullFileSystem->IBaseFileSystem, a2: &rootNodeHeader, a3: 76, a4: v57);
    if ( InputWorlds.m_Size > 0 )
    {
      v60 = v58;
      for ( fpNew = (void *)InputWorlds.m_Size; fpNew != nullptr; fpNew = (char *)fpNew - 1 )
      {
        v61 = (*v60)->GetNode(this: *v60, a2: 0);
        HIDWORD(nID) = v61->GetID(this: v61);
        g_pFullFileSystem->Write(this: &g_pFullFileSystem->IBaseFileSystem, a2: (char *)&nID + 4, a3: 4, a4: v57);
        v60 += 88;
      }
    }
    if ( InputWorlds.m_Size > 0 )
    {
      ...
      for ( fpNew = (void *)InputWorlds.m_Size; fpNew != nullptr; fpNew = (char *)fpNew - 1 )
      {
        (*v62)->WriteNodes(this: *v62, a2: v57);
        v62 += 88;
      }
    }
    g_pFullFileSystem->Close(this: &g_pFullFileSystem->IBaseFileSystem, a2: v57);
    v63 = InputWorlds.m_Size;
    if ( InputWorlds.m_Size > 0 )
    {
      do
      {
        g_pWorldRendererMgr->DestroyWorldRenderer(this: g_pWorldRendererMgr, a2: *v58);
        v58 += 88;
        --v63;
      }
      while ( v63 != 0 );
    }
    v64 = dictionaryList.m_Memory.m_pMemory;
    dictionaryList.m_Size = 0;
    if ( dictionaryList.m_Memory.m_nGrowSize >= 0 )
    {
      if ( dictionaryList.m_Memory.m_pMemory != nullptr )
      {
        _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: dictionaryList.m_Memory.m_pMemory);
        v64 = nullptr;
        dictionaryList.m_Memory.m_pMemory = nullptr;
      }
      dictionaryList.m_Memory.m_nAllocationCount = 0;
    }
    dictionaryList.m_pElements = v64;
    if ( dictionaryList.m_Memory.m_nGrowSize >= 0 )
    {
      if ( v64 != nullptr )
      {
    ...
    CUtlSymbolTable::~CUtlSymbolTable(this: &instancedEntries.m_SymbolTable);
    v65 = instancedEntries.m_Vector.m_Memory.m_pMemory;
    instancedEntries.m_Vector.m_Size = 0;
    if ( instancedEntries.m_Vector.m_Memory.m_nGrowSize >= 0 )
    {
      if ( instancedEntries.m_Vector.m_Memory.m_pMemory != nullptr )
      {
        _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: instancedEntries.m_Vector.m_Memory.m_pMemory);
        v65 = nullptr;
        instancedEntries.m_Vector.m_Memory.m_pMemory = nullptr;
      }
      instancedEntries.m_Vector.m_Memory.m_nAllocationCount = 0;
    }
    instancedEntries.m_Vector.m_pElements = v65;
    if ( instancedEntries.m_Vector.m_Memory.m_nGrowSize >= 0 )
    {
      if ( v65 != nullptr )
      {
    ...
    v66 = dictionaryEntries.m_Memory.m_pMemory;
    dictionaryEntries.m_Size = 0;
    if ( dictionaryEntries.m_Memory.m_nGrowSize >= 0 )
    {
      if ( dictionaryEntries.m_Memory.m_pMemory != nullptr )
      {
        _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: dictionaryEntries.m_Memory.m_pMemory);
        v66 = nullptr;
        dictionaryEntries.m_Memory.m_pMemory = nullptr;
      }
      dictionaryEntries.m_Memory.m_nAllocationCount = 0;
    }
    dictionaryEntries.m_pElements = v66;
    if ( dictionaryEntries.m_Memory.m_nGrowSize >= 0 )
    {
      if ( v66 != nullptr )
      {
    ...
    if ( InputWorlds.m_Memory.m_nGrowSize >= 0 )
      _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: InputWorlds.m_Memory.m_pMemory);
    return 1;
  }
  else
  {
LABEL_140:
    _Msg(a1: "concatworlds usage:\n");
    _Msg(a1: "concatworlds.exe -worldout <filename> worldfile1 worldfile2 [ worldfile3, etc ]\n");
    _Msg(a1: "\n");
    if ( InputWorlds.m_Memory.m_nGrowSize >= 0 && InputWorlds.m_Memory.m_pMemory != nullptr )
      _g_pMemAlloc->Free_2(this: _g_pMemAlloc, a2: InputWorlds.m_Memory.m_pMemory);
    return 0;
  }
}
...
//------------------------------------------------------------------------------
// Address: 0x00402890
// Name: public: virtual char const __near * CBakeWorldApp::GetAppName(void)
// Source: json
//------------------------------------------------------------------------------
const char *__thiscall CBakeWorldApp::GetAppName(CBakeWorldApp *this)
{
  return "ConcatWorlds";
}
