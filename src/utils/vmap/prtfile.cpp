...
// Original: utils/vmap/prtfile.cpp
// Functions: 9
// ============================================================
...
void __cdecl SaveClusters_r(node_t *node)
{
  ...
  v2 = clusterleaf + 1;
  word_35264EC[16 * clusterleaf] = i->cluster;
  clusterleaf = v2;
}
        ...
        const CUtlVector<cluster_portals_t,CUtlMemory<cluster_portals_t,int> > *list)
{
  ...
  if ( list->m_Size > 0 )
  {
    ...
    do
    {
      v4 = (cluster_portals_t *)((char *)v2->m_Memory.m_pMemory + v3);
      j = 0;
      if ( v4->portals.m_Size > 0 )
      {
        do
        {
          v5 = v4->portals.m_Memory.m_pMemory[j];
          winding = v5->winding;
          WindingPlane(w: winding, &normal, &dist);
          v7 = v5->nodes[1];
          if ( (float)((float)((float)(v5->plane.normal.y * normal.y) + (float)(v5->plane.normal.x * normal.x))
                     + (float)(v5->plane.normal.z * normal.z)) >= 0.99 )
            fprintf(str: pFile, format: "%i %i %i ", winding->numpoints, v5->nodes[0]->cluster, v7->cluster);
          else
            fprintf(str: pFile, format: "%i %i %i ", winding->numpoints, v7->cluster, v5->nodes[0]->cluster);
          v8 = 0;
          for ( i = 0; i < winding->numpoints; ++i )
          {
            fprintf(str: pFile, format: "(");
            v9.m128_i32[0] = 1258291200;
            x_low = (__m128)LODWORD(winding->p[v8].x);
            x_low.m128_f32[0] = x_low.m128_f32[0] + 0.5;
            v11 = _mm_and_ps((__m128)0x80000000, x_low);
            v9.m128_i32[0] = COERCE_UNSIGNED_INT(_mm_cmplt_ss(_mm_xor_ps(x_low, v11), v9).m128_f32[0]) & 0x4B000000
                           | v11.m128_i32[0];
            v12 = x_low;
            v12.m128_f32[0] = (float)(x_low.m128_f32[0] + v9.m128_f32[0]) - v9.m128_f32[0];
            v13 = v12;
            v13.m128_f32[0] = v12.m128_f32[0] - x_low.m128_f32[0];
            v14 = v12.m128_f32[0] - COERCE_FLOAT(COERCE_UNSIGNED_INT(_mm_cmpgt_ss(v13, v11).m128_f32[0]) & 0x3F800000);
            if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(winding->p[v8].x - v14) & _mask__AbsFloat_) >= 0.001 )
              fprintf(str: pFile, format: "%f ", winding->p[v8].x);
            else
              fprintf(str: pFile, format: "%i ", (int)v14);
            v15.m128_i32[0] = 1258291200;
            y_low = (__m128)LODWORD(winding->p[v8].y);
            y_low.m128_f32[0] = y_low.m128_f32[0] + 0.5;
            v17 = _mm_and_ps((__m128)0x80000000, y_low);
            v15.m128_i32[0] = COERCE_UNSIGNED_INT(_mm_cmplt_ss(_mm_xor_ps(y_low, v17), v15).m128_f32[0]) & 0x4B000000
                            | v17.m128_i32[0];
            v18 = y_low;
            v18.m128_f32[0] = (float)(y_low.m128_f32[0] + v15.m128_f32[0]) - v15.m128_f32[0];
            v19 = v18;
            v19.m128_f32[0] = v18.m128_f32[0] - y_low.m128_f32[0];
            v20 = v18.m128_f32[0] - COERCE_FLOAT(COERCE_UNSIGNED_INT(_mm_cmpgt_ss(v19, v17).m128_f32[0]) & 0x3F800000);
            if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(winding->p[v8].y - v20) & _mask__AbsFloat_) >= 0.001 )
              fprintf(str: pFile, format: "%f ", winding->p[v8].y);
            else
              fprintf(str: pFile, format: "%i ", (int)v20);
            v21.m128_i32[0] = 1258291200;
            z_low = (__m128)LODWORD(winding->p[v8].z);
            z_low.m128_f32[0] = z_low.m128_f32[0] + 0.5;
            v23 = _mm_and_ps((__m128)0x80000000, z_low);
            v21.m128_i32[0] = COERCE_UNSIGNED_INT(_mm_cmplt_ss(_mm_xor_ps(z_low, v23), v21).m128_f32[0]) & 0x4B000000
                            | v23.m128_i32[0];
            v24 = z_low;
            v24.m128_f32[0] = (float)(z_low.m128_f32[0] + v21.m128_f32[0]) - v21.m128_f32[0];
            v25 = v24;
            v25.m128_f32[0] = v24.m128_f32[0] - z_low.m128_f32[0];
            v26 = v24.m128_f32[0] - COERCE_FLOAT(COERCE_UNSIGNED_INT(_mm_cmpgt_ss(v25, v23).m128_f32[0]) & 0x3F800000);
            if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(winding->p[v8].z - v26) & _mask__AbsFloat_) >= 0.001 )
              fprintf(str: pFile, format: "%f ", winding->p[v8].z);
            else
              fprintf(str: pFile, format: "%i ", (int)v26);
            fprintf(str: pFile, format: ") ");
            ++v8;
          }
          fprintf(str: pFile, format: "\n");
          v4 = &list->m_Memory.m_pMemory[v31 / 0x14];
          ++j;
        }
        while ( j < v4->portals.m_Size );
        v2 = list;
      }
      v3 = v31 + 20;
      ++clusterIndex;
...
void __cdecl AddVisCluster(entity_t *pFuncVisCluster)
{
  ...
  CUtlVector<Quaternion,CUtlMemory<Quaternion,int>>::InsertBefore(
    this: (CUtlVector<Quaternion,CUtlMemory<Quaternion,int> > *)&g_VisClusters,
    elem: g_VisClusters.m_Size,
    src: (const Quaternion *)&tmp);
  ...
  else
  {
    ...
    if ( m_Size + 1 > m_nAllocationCount )
      CUtlMemory<HemiLightData_t *,int>::Grow(
        this: (CUtlMemory<S3RGBA,int> *)leaves,
        ...
        do
        {
          ...
          if ( v6 == v4 )
          {
            if ( v6->cluster != portals->nodes[1]->cluster && Portal_VisFlood(p: portals) )
            {
              ...
              if ( m_Size + 1 > m_nAllocationCount )
                CUtlMemory<HemiLightData_t *,int>::Grow(this: v8, num: m_Size - m_nAllocationCount + 1);
              ++v8[1].m_pMemory;
...
void __cdecl WritePortalFile(tree_t *tree)
{
  ...
  CUtlVector<cluster_portals_t,CUtlMemory<cluster_portals_t,int>>::RemoveAll(this: (CUtlVector<CUtlVector<CStudioHdr::CActivityToSequenceMapping::HashValueType,CUtlMemory<CStudioHdr::CActivityToSequenceMapping::HashValueType,int> >,CUtlMemory<CUtlVector<CStudioHdr::CActivityToSequenceMapping::HashValueType,CUtlMemory<CStudioHdr::CActivityToSequenceMapping::HashValueType,int> >,int> > *)&portalList);
  ...
  CUtlVector<TextureData_t,CUtlMemory<TextureData_t,int>>::~CUtlVector<TextureData_t,CUtlMemory<TextureData_t,int>>(this: (CUtlVector<CVTFTexture::ResourceMemorySection,CUtlMemory<CVTFTexture::ResourceMemorySection,int> > *)&leaves);
}
