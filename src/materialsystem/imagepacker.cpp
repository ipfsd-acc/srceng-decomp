...
// Original: materialsystem/imagepacker.cpp
// Functions: 3
// ============================================================

#include "materialsystem\imagepacker.h"
...
void __thiscall CImagePacker::GetMinimumDimensions(CImagePacker *this, int *pReturnWidth, int *pReturnHeight)
{
  ...
  *pReturnWidth = CeilPow2(in: this->m_MaxLightmapWidth);
  v4 = CeilPow2(in: this->m_MinimumHeight);
  *pReturnHeight = v4;
  v5 = *pReturnWidth / v4;
  if ( v5 > g_pHWConfig->MaxTextureAspectRatio(this: g_pHWConfig) )
    *pReturnHeight = *pReturnWidth / g_pHWConfig->MaxTextureAspectRatio(this: g_pHWConfig);
}
